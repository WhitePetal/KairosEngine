use std::{any::TypeId, iter, mem::MaybeUninit};
...
unsafe impl<C: Component> Bundle for C {
    ...
    ) -> impl Iterator<Item = crate::component::ComponentId> + use<C> {
...
unsafe impl<C: Component> BundleFromComponents for C {
    ...
    where
        ...
        F: for<'a> FnMut(&'a mut T) -> crate::ptr::OwningPtr<'a>,
        Self: Sized,
    {
        let ptr = func(ctx);
...
impl<C: Component> DynamicBundle for C {
    ...
    unsafe fn apply_effect(
        ...
        _entity: &mut crate::world::EntityWorldMut,
    ) {
    }
}
