extern crate self as kairos_ecs;
...
// Bevy parity: re-export the pointer crate so `crate::ptr` (used across the
// ECS internals and by derive-macro expansions) keeps resolving at this root.
pub use kairos_ptr as ptr;
