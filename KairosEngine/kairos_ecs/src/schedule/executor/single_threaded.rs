...
use crate::{
    ...
    schedule::{
        ConditionWithAccess, SystemExecutor, SystemSchedule,
...
impl SystemExecutor for SingleThreadedExecutor {
    fn init(&mut self, schedule: &super::SystemSchedule) {
        // pre-allocate space
    ...
    fn run(
        ...
        error_handler: fn(crate::error::KairosError, crate::error::ErrorContext),
    ) {
