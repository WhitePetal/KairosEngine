...
const _: () = {
    ...
    pub struct FetchState {
        state: <__StructFieldsAlias<'static, 'static> as crate::system::SystemParam>::State,
    }
    // SAFETY: Only reads Entities
    unsafe impl crate::system::SystemParam for Commands<'_, '_> {
        ...
        fn init_access(
            ...
            <__StructFieldsAlias<'_, '_> as crate::system::SystemParam>::init_access(
                &state.state,
                system_meta,
        ...
        fn apply(state: &mut Self::State, system_meta: &super::SystemMeta, world: &mut World) {
            <__StructFieldsAlias<'_, '_> as crate::system::SystemParam>::apply(
                &mut state.state,
                system_meta,
                world,
            );
        ...
        fn queue(
            ...
            <__StructFieldsAlias<'_, '_> as crate::system::SystemParam>::queue(
                &mut state.state,
                system_meta,
                world,
            );
        ...
        unsafe fn get_param<'world, 'state>(
            ...
            let params = unsafe {
                <__StructFieldsAlias as crate::system::SystemParam>::get_param(
                    &mut state.state,
                    system_meta,
                    world,
                    change_tick,
    ...
    // SAFETY: Only reads Entities
    unsafe impl<'w, 's> crate::system::ReadOnlySystemParam for Commands<'w, 's>
    where
        Deferred<'s, CommandQueue>: crate::system::ReadOnlySystemParam,
        &'w Entities: crate::system::ReadOnlySystemParam,
    {
    }
};
