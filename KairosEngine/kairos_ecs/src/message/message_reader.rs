...
impl<'w, 's, M: Message> std::ops::Deref for PopulatedMessageReader<'w, 's, M> {
...
impl<'w, 's, M: Message> DerefMut for PopulatedMessageReader<'w, 's, M> {
...
unsafe impl<'w, 's, M: Message> SystemParam for PopulatedMessageReader<'w, 's, M> {
    ...
    ) -> Result<Self::Item<'world, 'state>, crate::system::SystemParamValidationError> {
