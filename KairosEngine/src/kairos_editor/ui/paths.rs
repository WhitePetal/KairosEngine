...
pub const PATH_EDITOR_WINDO_TOOL_BAR_STYLE: &'static str = "Preferences/Styles/EditorWindowToolBarStyle.json";
...
pub const PATH_SCENE_WINDOW_STYLE: &'static str = "Preferences/Styles/SceneWindowStyle.json";