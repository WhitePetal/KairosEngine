...
pub const ENTITY_MASK: u64 = 0xFFFFFFFF;

pub const FLAG_MASK_LEN: u32 = FLAG_MASK.count_ones();
pub const VERSION_MASK_LEN: u32 = VERSION_MASK.count_ones();
pub const ENTITY_MASK_LEN: u32 = ENTITY_MASK.count_ones();

pub const ENTITY_MASK_OFFSET: u32 = ENTITY_MASK_LEN;
pub const VERSION_MASK_OFFSET: u32 = ENTITY_MASK_OFFSET + VERSION_MASK_LEN;
