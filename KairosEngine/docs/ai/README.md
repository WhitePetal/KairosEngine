...
| [ecs-spatial-cell-partitioning-design.md](./ecs-spatial-cell-partitioning-design.md) | 空间 Cell ID 作为 ECS Table 第二维分区键的方案设计：八叉树+ECS组合查询的缓存友好性分析、`query_disjoint_mut`不适用原因、CellId分区与UE5 World Partition的对应关系 |
