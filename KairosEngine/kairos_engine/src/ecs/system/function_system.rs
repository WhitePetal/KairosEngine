...
use crate::{
    ...
    ecs::{
        ...
        system::{
            ...
            SystemInput, SystemParam, SystemParamBuilder, SystemParamItem,
            SystemParamValidationError, SystemStateFlags, check_system_change_tick,
        },
    ...
    F: SystemParamFunction<Marker, In: FromInput<In>, Out: IntoResult<Out>>,
{
    ...
    fn default_system_sets(&self) -> Vec<InternedSystemSet> {
        let set = crate::ecs::schedule::SystemTypeSet::<F>::new();
        vec![set.intern()]
    }
