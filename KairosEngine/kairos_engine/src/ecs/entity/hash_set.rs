...
impl EntityHashSet {
    ...
    pub const fn new() -> Self {
        Self(FixedHashSet::with_hasher(EntityHash))
    }
    ...
    pub fn with_capacity(n: usize) -> Self {
        Self(FixedHashSet::with_capacity_and_hasher(n, EntityHash))
    }
    ...
    pub const fn from_hash_set(set: FixedHashSet<Entity, EntityHash>) -> Self {
        Self(set)
    }

    /// Returns the inner [`HashSet`].
    pub fn into_inner(self) -> FixedHashSet<Entity, EntityHash> {
        self.0
    }
...
impl Deref for EntityHashSet {
    type Target = FixedHashSet<Entity, EntityHash>;
...
impl From<FixedHashSet<Entity, EntityHash>> for EntityHashSet {
    fn from(value: FixedHashSet<Entity, EntityHash>) -> Self {
        Self(value)
    }
}
