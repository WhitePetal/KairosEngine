...
impl BlobArray {
    ...
    pub unsafe fn with_capacity(
        ...
        if capacity == 0 {
            ...
            debug_assert_eq!(
                ...
                item_layout,
                "Layout size muts be a multiple of ites alignment"
            );
    ...
    /// - The slot at `index` must be uninitialized; it must not already hold a value.
    ///   Otherwise, the existing value would be overwritten without being dropped.
