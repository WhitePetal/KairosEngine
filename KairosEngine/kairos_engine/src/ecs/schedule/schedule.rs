...
use kairos_ecs_macros::{Event, ScheduleLabel};
use log::{info, warn};
use thiserror::Error;
#[cfg(feature = "trace")]
...
use crate::{
    ...
    ecs::{
        ...
        resource::Resource,
        schedule::{
            AnonymousSet, BoxedCondition, ConflictingSystems, InternedScheduleLabel,
            InternedSystemSet, IntoScheduleConfigs, IntoSystemSet, NodeId, Schedulable,
            ScheduleBuildError, ScheduleBuildWarning, ScheduleConfig, ScheduleConfigs,
            ScheduleError, ScheduleLabel, SystemExecutor, SystemKey, SystemSchedule, SystemSet,
            SystemSetKey, SystemSets, SystemWithAccess, Systems, default_executor,
            graph::{
...
pub struct ScheduleBuildMetadata {
    ...
    /// build process.
    pub edges_added_by_build_passes: FixedHashSet<(SystemKey, SystemKey)>,
}
