// use crate::ecs::{
//     change_detection::ResMut, component::Component, entity::Entity, event::{EntityComponentsTrigger, EntityEvent, Event}, lifecycle::{Add, Discard, Insert, Remove}, observer::{ObservedBy, Observer, On}, resource::Resource, world::World,
// };
