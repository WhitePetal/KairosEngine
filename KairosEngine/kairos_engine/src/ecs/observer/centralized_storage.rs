...
pub struct CachedObservers {
    ...
    pub(super) component_observers: FixedHashMap<ComponentId, CachedComponentObservers>,
...
impl CachedObservers {
    ...
    pub fn component_observers(&self) -> &FixedHashMap<ComponentId, CachedComponentObservers> {
