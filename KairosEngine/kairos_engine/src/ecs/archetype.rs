...
pub struct Edges {
    ...
    remote_bundle: SparseArray<BundleId, Option<ArchetypeId>>,
...
impl Edges {
    ...
    pub fn get_archetype_after_bundle_remove(
        ...
        self.remote_bundle.get(bundle_id).cloned()
    }
    ...
    pub(crate) fn cache_archetype_after_bundle_remove(
        ...
        self.remote_bundle.insert(bundle_id, archetype_id);
    }
...
pub type ComponentIndex = FixedHashMap<ComponentId, FixedHashMap<ArchetypeId, ArchetypeRecord>>;
...
pub struct Archetypes {
    ...
    by_components: FixedHashMap<ArchetypeComponents, ArchetypeId>,
