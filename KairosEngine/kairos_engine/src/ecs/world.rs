...
use crate::{
    ...
    ecs::{
        ...
        change_detection::{
            CHECK_TICK_THRESHOLD, CheckChangeTicks, ComponentTicks, ComponentTicksMut, Mut,
            MutUntyped, Ref, Tick,
        },
        component::{
        ...
        lifecycle::{
            ADD, Add, ComponentHooks, DESPAWN, DISCARD, Despawn, Discard, INSERT, Insert, REMOVE,
            Remove, RemovedComponentMessages,
        },
        ...
        world::{
            ...
            error::{
                EntityDespawnError, EntityMutableFetchError, TryInsertBatchError,
                TryRunScheduleError,
            },
                ...
                Ok(first_location) => {
                    ...
                    for (entity, bundle) in batch_iter {
                        match cache.inserter.entities().get_spawned(entity) {
                            ...
                            Err(err) => {
                                panic!(
                                    "error[B0003]: Could not insert a bundle (of type `{}`) for entity {entity} because: {err}. See: https://bevyengine.org/learn/errors/b0003",
                                    core::any::type_name::<B>()
                                );
                            }
                        }
