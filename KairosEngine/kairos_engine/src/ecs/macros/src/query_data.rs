use kairos_macro_utils::fq_std::{FQIterator, FQOption};
use kairos_macro_utils::{ensure_no_collision, get_struct_fields};
use proc_macro::TokenStream;
use proc_macro2::Span;
use quote::{format_ident, quote};
use syn::{
    Attribute, DeriveInput, Fields, Ident, ImplGenerics, Member, Meta, Type, TypeGenerics,
    Visibility, WhereClause, parse_macro_input, parse_quote, punctuated::Punctuated, token::Comma,
};
