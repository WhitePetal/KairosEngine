...
use crate::{
    ...
    ui::{
        ...
        ui_style_fields::{
            FloatFieldEditViewType, FloatStyleField, RangeStyleField, StyleField, Vector3StyleField,
        },
    },
};
...
impl Drawer for SceneWindow {
    ...
    fn render(
        ...
        engine: &mut Engine,
        messager: &mut super::Messager,
    ) -> Option<kairos_engine::graphics::graphics_graph::GraphicsCommand> {
        ...
        let scene_view = Attachment::new(
            ...
            size.width,
            size.height,
            kairos_engine::graphics::attachment::AttachmentFormat::RGBA8UNorm,
        );
        let scene_depth_stencil = Attachment::new(
            Some("SceneWindow DepthStencil"),
            size.width,
            size.height,
            kairos_engine::graphics::attachment::AttachmentFormat::D24S8,
        );
