...
use kairos_engine::asset::{AssetServer, Assets, Handle};
use serde::{Deserialize, Serialize};

use crate::ui::{Message, UIReader, dialog::Dialog, inspector::Inspector, paths};
use kairos_engine::{
    Engine,
    audio::{
        AudioEngine,
...
impl Inspector for AudioInspector {
    ...
    fn draw(
        ...
        ui: &mut egui::Ui,
        _reader: &UIReader,
        messager: &mut crate::ui::Messager,
        world: &kairos_ecs::world::World,
        _dt: f32,
    ) {
...
impl AudioInspector {
    ...
    fn draw_waveform(&self, ui: &mut egui::Ui, pcm: &PcmData, messager: &mut crate::ui::Messager) {
        ...
        ui.horizontal(|ui| {
            ...
            ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                ...
                if ui.button(btn_text).clicked() {
                    messager.send(crate::ui::Message::AudioInspectorTogglePreview);
                }
            });
        });
        ...
        if resp.clicked() {
            if let Some(pos) = resp.interact_pointer_pos() {
                ...
                messager.send(crate::ui::Message::AudioInspectorSeekPreview(seek_time));
            }
        }
    }
