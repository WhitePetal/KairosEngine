...
use kairos_engine::asset::{AssetOptions, AssetServer, install};

use crate::ui::inspector::material::MaterialInspector;
...
fn asset_world() -> World {
    ...
    kairos_engine::graphics::material::install(&mut world);
    world
}
...
fn discard_changes_no_crash_when_serialized_unloaded() {
    ...
    let material_handle = world
        .resource::<AssetServer>()
        .load::<kairos_engine::graphics::material::Material>(mat_path.clone());
