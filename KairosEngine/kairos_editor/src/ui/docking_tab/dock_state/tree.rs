...
use crate::ui::docking_tab::{dock_state::tree::node::Node, surfaces::SurfaceIndex};
...
impl<Drawer> Tree<Drawer> {
    ...
    ///
    /// ```rust
    /// use kairos_editor::ui::docking_tab::{dock_state::DockState, dock_state::tree::NodeIndex};
    ...
    ///
    /// ```rust
    /// use kairos_editor::ui::docking_tab::dock_state::DockState;
    ...
    ///
    /// ```rust
    /// use kairos_editor::ui::docking_tab::{dock_state::DockState, dock_state::tree::{NodeIndex, Split}, surfaces::SurfaceIndex};
    ...
    ///
    /// ```rust
    /// use kairos_editor::ui::docking_tab::{dock_state::DockState, dock_state::tree::{NodeIndex, Split, node::Node}, surfaces::SurfaceIndex};
    /// let mut dock_state = DockState::new(vec!["tab 1", "tab 2"]);
    ///
    /// // At this point, the main surface only contains the leaf with tab 1 and 2.
    /// assert!(dock_state.main_surface().root_node().unwrap().is_leaf());
