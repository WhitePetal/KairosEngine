...
/// How many text slots [`Assets<Text>`](kairos_engine::asset::Assets) preallocates.
///
...
impl AssetLoader for TextLoader {
    ...
    /// claimed by [`ShaderLoader`](kairos_engine::graphics::shader::ShaderLoader), and
...
///
/// Must run after [`kairos_engine::asset::install`], which creates the
