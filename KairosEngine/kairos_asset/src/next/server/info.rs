...
//! ([`Assets<A>`](crate::next::Assets)) owns the values, the server owns what is
...
use crate::next::handle::{AssetHandleProvider, Handle, StrongHandle, UntypedHandle};
use crate::next::id::UntypedAssetId;
use crate::next::index::AssetIndexAllocator;
use crate::next::loader::ErasedLoadedAsset;
